...
import { Truck, Calendar, ShieldCheck, UserPlus, CheckCircle2, LogOut, Users, Shield, Cloud, Database } from 'lucide-react';
...
export const Header: React.FC<HeaderProps> = ({
  ...
  const { profile, user, role, signOut, isCloudConnected } = useAuth();
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-50 hover:bg-slate-100 text-slate-700 border border-slate-300 rounded-xl text-xs font-medium transition-colors shadow-2xs"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3.5 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-xs font-semibold transition-colors shadow-xs"
            >
